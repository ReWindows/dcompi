//! Windissect-generated Rust FFI bindings for dcompi.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "1D2CBCBB0F02D69AF6918085A83937DC";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 2912017915;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 11] = [100, 99, 111, 109, 112, 105, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 2912017915 { return 0; }

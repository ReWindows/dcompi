...
public:
    ...
    // Category: Method | Source: PDB Internal
    // Symbol: ?Intersects@CStripe@Internal@FastRegion@@SA_NPEBV123@0@Z
    static bool Intersects(::FastRegion::Internal::CStripe const *, ::FastRegion::Internal::CStripe const *);
    // Category: Method | Source: PDB Internal

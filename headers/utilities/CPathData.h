...
public:
    ...
    // Symbol: ?Initialize@CPathData@@QEAAXV?$span@$$CBE$0?0@gsl@@@Z
    void Initialize(WindissectOpaque);
    // Category: Method | Source: PDB Internal
    // Symbol: ?Open@CPathData@@QEAAJPEAPEAUID2D1GeometrySink@@@Z
    long Open(ID2D1GeometrySink * *);
protected:
...
private:
    ...
    void AppendSegment(::Path::Segment *);
    // Category: Method | Source: PDB Internal

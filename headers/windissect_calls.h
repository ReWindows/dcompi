...
static constexpr wchar_t module_name[11] = {0x0064, 0x0063, 0x006F, 0x006D, 0x0070, 0x0069, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 2912017915U || rva >= image_size) return nullptr;
return base + rva;
}
